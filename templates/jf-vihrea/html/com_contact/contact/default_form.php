	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>
			...
			<?php if ($this->params->get('show_email_copy')) { ?>
				<div class="control-group group-email-copy">
					<div class="control-label email-copy"><?php echo $this->form->getLabel('contact_email_copy'); ?> <?php echo $this->form->getInput('contact_email_copy'); ?></div>
				</div>
			<?php } ?>
