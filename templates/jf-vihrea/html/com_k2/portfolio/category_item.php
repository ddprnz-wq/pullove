...
<?php
	if ($classWidth == 'width4')
		$this->item->image = JURI::root(true).'/media/k2/items/cache/'.md5("Image".$this->item->id).'_L.jpg';
?>

<div class="itemContainer <?php echo $classWidth; ?> <?php echo strtolower(str_replace(" ", "", JText::_( $this->item->category->name ))); ?>" data-category="<?php echo strtolower(str_replace(" ", "", JText::_( $this->item->category->name ))); ?>">
		    ...
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
                ...
                <div class="thumb-overlay-inner">
                    <div class="thumb-overlay-content">
                        <p class="thumb-overlay-title"><?php echo $this->item->title; ?></p>
                    </div>
                </div>
...
<?php /*?>	  <?php if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields)): ?>
	  <!-- Item extra fields -->
