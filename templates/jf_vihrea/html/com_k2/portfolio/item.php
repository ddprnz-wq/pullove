...
<div id="isotope" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">

  <div class="itemBody <?php if($this->item->params->get('itemImageGallery') && !empty($this->item->gallery)) echo 'width4'; else echo 'width6'; ?>"><div class="itemBodyInner">
  ...
  <?php echo $this->item->event->K2AfterDisplayTitle; ?>
      ...
      <div class="itemNavigation">
            ...
            <a class="itemPrevious" href="<?php echo $this->item->previousLink; ?>"></a>
            <?php endif; ?>
    
            <?php if(isset($this->item->nextLink)): ?>
            <a class="itemNext" href="<?php echo $this->item->nextLink; ?>"></a>
            <?php endif; ?>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
    ...
    <?php if($this->item->params->get('itemImageGallery') && !empty($this->item->gallery)): ?>
      <!-- Item image gallery -->
      <div class="itemImageGallery width2"><div class="itemGalleryInner">
